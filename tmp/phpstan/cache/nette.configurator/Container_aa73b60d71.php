...
class Container_aa73b60d71 extends _PHPStan_f1e88529a\Nette\DI\Container
{
    protected $tags = [
    ...
    public function createService0365(): PHPStan\File\FileExcluderRawFactory
    {
        return new class($this) implements PHPStan\File\FileExcluderRawFactory
        {
            ...
            public function __construct(Container_aa73b60d71 $container)
            {
    ...
    public function createServiceContainer(): Container_aa73b60d71
    {
        return $this;
    }
