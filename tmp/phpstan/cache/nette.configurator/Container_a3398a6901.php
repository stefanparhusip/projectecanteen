...
class Container_a3398a6901 extends _PHPStan_f1e88529a\Nette\DI\Container
{
    protected $tags = [
    ...
    public function createService0365(): PHPStan\File\FileExcluderRawFactory
    {
        return new class($this) implements PHPStan\File\FileExcluderRawFactory
        {
            ...
            public function __construct(Container_a3398a6901 $container)
            {
    ...
    public function createServiceContainer(): Container_a3398a6901
    {
        return $this;
    }
